...
## [`v0.24.0`](https://github.com/Source-Protocol-Cosmos/cli/releases/tag/v0.24.0)
...
## [`v0.23.0`](https://github.com/Source-Protocol-Cosmos/cli/releases/tag/v0.23.0)
...
## [`v0.22.2`](https://github.com/Source-Protocol-Cosmos/cli/releases/tag/v0.22.2)
...
## [`v0.22.1`](https://github.com/Source-Protocol-Cosmos/cli/releases/tag/v0.22.1)

### Fixes 

- Fix IBC module scaffolding interface in templates

## [`v0.22.0`](https://github.com/Source-Protocol-Cosmos/cli/releases/tag/v0.22.0)
...
## [`v0.21.2`](https://github.com/Source-Protocol-Cosmos/cli/releases/tag/v0.21.2)

### Fixes 

- Set min. gas to zero when running `chain` command set 

## [`v0.21.1`](https://github.com/Source-Protocol-Cosmos/cli/releases/tag/v0.21.1)
...
## [`v0.21.0`](https://github.com/Source-Protocol-Cosmos/cli/releases/tag/v0.21.0)
...
## [`v0.20.4`](https://github.com/Source-Protocol-Cosmos/cli/releases/tag/v0.20.4)

### Fixes

- Use `protoc` binary compiled in an older version of macOS AMD64 for backwards compatibility in code generation

## [`v0.20.3`](https://github.com/Source-Protocol-Cosmos/cli/releases/tag/v0.20.3)
...
## [`v0.20.2`](https://github.com/Source-Protocol-Cosmos/cli/releases/tag/v0.20.2)

### Fixes

- Use `unsafe-reset-all` cmd under `tendermint` cmd for chains that use `=> v0.45.3` version of Cosmos SDK

## [`v0.20.1`](https://github.com/Source-Protocol-Cosmos/cli/releases/tag/v0.20.1)

### Features

- Release the CLI with Linux ARM and native M1 binaries

## [`v0.20.0`](https://github.com/Source-Protocol-Cosmos/cli/releases/tag/v0.20.0)
...
## [`v0.19.5`](https://github.com/Source-Protocol-Cosmos/cli/pull/2158/commits)
...
## [`v0.19.2`](https://github.com/Source-Protocol-Cosmos/cli/milestone/14)
...
- Deprecated the Starport Modules [tendermint/spm](https://github.com/tendermint/spm) repo and moved the contents to the Ignite CLI repo [`ignite/pkg/`](https://github.com/Source-Protocol-Cosmos/cli/tree/develop/ignite/pkg/) in [PR 1971](https://github.com/Source-Protocol-Cosmos/cli/pull/1971/files) 
...
- Updated the faucet HTTP API schema. See API changes in [fix: improve faucet reliability #1974](https://github.com/Source-Protocol-Cosmos/cli/pull/1974/files#diff-0e157f4f60d6fbd95e695764df176c8978d85f1df61475fbfa30edef62fe35cd)
