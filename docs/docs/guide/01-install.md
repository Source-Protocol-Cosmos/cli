...
You can run [Ignite CLI](https://github.com/Source-Protocol-Cosmos/cli) in a web-based Gitpod IDE or you can install Ignite CLI on your local computer.
...
For details on version features and changes, see the [changelog.md](https://github.com/Source-Protocol-Cosmos/cli/blob/develop/changelog.md) in the repo.
...
```bash
git clone https://github.com/Source-Protocol-Cosmos/cli --depth=1
cd cli && make install
```
