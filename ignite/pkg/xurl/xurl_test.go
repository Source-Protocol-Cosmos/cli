...
func TestTCP(t *testing.T) {
	cases := []struct {
		...
		{
			name: "with scheme",
			addr: "tcp://github.com/Source-Protocol-Cosmos/cli",
			want: "tcp://github.com/Source-Protocol-Cosmos/cli",
		},
		{
			name: "without scheme",
			addr: "github.com/Source-Protocol-Cosmos/cli",
			want: "tcp://github.com/Source-Protocol-Cosmos/cli",
		},
		{
			name: "with invalid scheme",
			addr: "ftp://github.com/Source-Protocol-Cosmos/cli",
			want: "tcp://github.com/Source-Protocol-Cosmos/cli",
		},
		{
...
func TestHTTP(t *testing.T) {
	cases := []struct {
		...
		{
			name: "with scheme",
			addr: "http://github.com/Source-Protocol-Cosmos/cli",
			want: "http://github.com/Source-Protocol-Cosmos/cli",
		},
		{
			name: "without scheme",
			addr: "github.com/Source-Protocol-Cosmos/cli",
...
func TestHTTPS(t *testing.T) {
	cases := []struct {
		...
		{
			name: "with scheme",
			addr: "https://github.com/Source-Protocol-Cosmos/cli",
			want: "https://github.com/Source-Protocol-Cosmos/cli",
		},
		{
			name: "without scheme",
			addr: "github.com/Source-Protocol-Cosmos/cli",
...
func TestWS(t *testing.T) {
	cases := []struct {
		...
		{
			name: "with scheme",
			addr: "ws://github.com/Source-Protocol-Cosmos/cli",
			want: "ws://github.com/Source-Protocol-Cosmos/cli",
		},
		{
			name: "without scheme",
			addr: "github.com/Source-Protocol-Cosmos/cli",
